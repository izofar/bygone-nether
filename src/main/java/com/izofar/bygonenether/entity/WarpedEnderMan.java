...
public class WarpedEnderMan extends EnderMan{
	...
	private static final Map<SoundEvent, SoundEvent> SOUND_MAP = ImmutableMap.of(
			SoundEvents.ENDERMAN_AMBIENT, ModSounds.WARPED_ENDERMAN_AMBIENT,
			SoundEvents.ENDERMAN_DEATH, ModSounds.WARPED_ENDERMAN_DEATH,
			SoundEvents.ENDERMAN_HURT, ModSounds.WARPED_ENDERMAN_HURT,
			SoundEvents.ENDERMAN_SCREAM, ModSounds.WARPED_ENDERMAN_SCREAM,
			SoundEvents.ENDERMAN_STARE, ModSounds.WARPED_ENDERMAN_STARE,
			SoundEvents.ENDERMAN_TELEPORT, ModSounds.WARPED_ENDERMAN_TELEPORT
	);
