...
public class CorporRenderer extends BipedRenderer<CorporEntity, CorporModel> {
    ...
    @Override
    public ResourceLocation getTextureLocation(CorporEntity wither){ return BRUTE_LOCATION; }

    protected void scale(CorporEntity corporEntity, MatrixStack stack, float f) {
