...
public class WarpedEndermanModel extends EndermanModel<WarpedEnderMan> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        stemBody.addOrReplaceChild("stem_body_r1", CubeListBuilder.create().texOffs(42, 0).addBox(-6.0F, -14.0F, -0.5F, 6.0F, 15.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-4.0F, -40.0F, 0.0F, 0.0F, -0.3927F, 0.0F));
        ...
        leftArm.addOrReplaceChild("stem_arm", CubeListBuilder.create().texOffs(35, 0).addBox(-4.0F, -38.0F, -0.5F, 6.0F, 15.0F, 1.0F, CubeDeformation.NONE), PartPose.offset(5.0F, 37.0F, 0.0F));
    ...
    @Override
    public void setupAnim(WarpedEnderMan entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
