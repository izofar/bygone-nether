...
public class ModArmorItem extends ArmorItem {
	...
	public ModArmorItem(ArmorMaterial material, EquipmentSlot slot, FabricItemSettings properties) {
		super(material, slot, properties.customDamage(new ModArmorItemDamageHandler()));
	}
