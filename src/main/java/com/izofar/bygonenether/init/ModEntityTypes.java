...
public abstract class ModEntityTypes {
	...
	public static final RegistryObject<EntityType<ModPiglinBruteEntity>> PIGLIN_BRUTE = VANILLA_ENTITY_TYPES.register("piglin_brute", () -> EntityType.Builder.of(ModPiglinBruteEntity::new, EntityClassification.MONSTER).sized(0.6F, 1.95F).clientTrackingRange(8).build(new ResourceLocation("minecraft:piglin_brute").toString()));
