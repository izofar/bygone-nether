...
public abstract class ModBlocks {
	...
	private static void registerModCompatibilityBlocks() {
		if (ModList.get().isLoaded("quark")) {
			WITHERED_BLACKSTONE_VERTICAL_SLAB = MODDED_BLOCKS.register("withered_blackstone_vertical_slab", () -> new VerticalSlabBlock(AbstractBlock.Properties.copy(WITHERED_BLACKSTONE_SLAB.get())));
			CRACKED_WITHERED_BLACKSTONE_VERTICAL_SLAB = MODDED_BLOCKS.register("cracked_withered_blackstone_vertical_slab", () -> new VerticalSlabBlock(AbstractBlock.Properties.copy(CRACKED_WITHERED_BLACKSTONE_SLAB.get())));
			WARPED_NETHER_BRICK_VERTICAL_SLAB = MODDED_BLOCKS.register("warped_nether_brick_vertical_slab", () -> new VerticalSlabBlock(AbstractBlock.Properties.copy(WARPED_NETHER_BRICK_SLAB.get())));
		}
	}
