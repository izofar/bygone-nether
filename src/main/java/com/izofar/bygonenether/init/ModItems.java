...
public abstract class ModItems {
	...
	public static final RegistryObject<Item> WITHER_WALTZ_MUSIC_DISC = MODDED_ITEMS.register("wither_waltz_music_disc", () -> new RecordItem(4, ModSounds.WITHER_WALTZ, new Item.Properties().tab(ModCreativeModeTabs.MOD_TAB).stacksTo(1).rarity(Rarity.RARE)));
