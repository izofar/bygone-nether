...
public abstract class ModItems {
	...
	public static final RegistryObject<Item> WRAITHER_SPAWN_EGG = MODDED_ITEMS.register("wraither_spawn_egg", () -> new ForgeSpawnEggItem(ModEntityTypes.WRAITHER, 0x273333, 0x474d4d, (new Item.Properties()).tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> CORPOR_SPAWN_EGG = MODDED_ITEMS.register("corpor_spawn_egg", () -> new ForgeSpawnEggItem(ModEntityTypes.CORPOR, 0x141414, 0x4a5757, (new Item.Properties()).tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> WITHER_SKELETON_KNIGHT_SPAWN_EGG = MODDED_ITEMS.register("wither_skeleton_knight_spawn_egg", () -> new ForgeSpawnEggItem(ModEntityTypes.WITHER_SKELETON_KNIGHT, 0x242424, 0x4e5252, (new Item.Properties()).tab(CreativeModeTab.TAB_MISC)));
	...
	public static final RegistryObject<Item> WITHER_WALTZ_MUSIC_DISC = MODDED_ITEMS.register("wither_waltz_music_disc", () -> new RecordItem(4, () -> ModSounds.WITHER_WALTZ.get(), new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(1).rarity(Rarity.RARE), 5040));
