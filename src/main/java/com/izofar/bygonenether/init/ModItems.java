...
public class ModItems {
    ...
    public static final Item WITHER_WALTZ_MUSIC_DISC = new RecordItem(4, ModSounds.WITHER_WALTZ, new FabricItemSettings().maxCount(1).group(ModCreativeModeTabs.MOD_TAB));
