...
public abstract class ModConfiguredFeatures {
	...
	public static final ConfiguredFeature<?, ?> CONFIGURED_MOB_FEATURE_CATACOMB = ModFeatures.MOB_FEATURE_CATACOMB.get().configured(IFeatureConfig.NONE);
	...
	public static void registerConfiguredFeatures() {
		...
		// For some reason, these did not work without JSON
		...
		Registry.register(registry, new ResourceLocation(BygoneNetherMod.MODID, "mob_feature_catacomb"), CONFIGURED_MOB_FEATURE_CATACOMB);
