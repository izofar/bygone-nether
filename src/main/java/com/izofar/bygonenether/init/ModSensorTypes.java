...
public class ModSensorTypes {
    ...
    public static void registerSensorTypes() {
        Registry.register(BuiltInRegistries.SENSOR_TYPE, new ResourceLocation(BygoneNetherMod.MODID, "piglin_brute_specific_sensor"), PIGLIN_BRUTE_SPECIFIC_SENSOR);
        Registry.register(BuiltInRegistries.SENSOR_TYPE, new ResourceLocation(BygoneNetherMod.MODID, "piglin_prisoner_specific_sensor"), PIGLIN_PRISONER_SPECIFIC_SENSOR);
    }
}
