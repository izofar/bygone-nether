...
public abstract class ModFeatures {
	...
	public static final RegistryObject<Feature<NoneFeatureConfiguration>> MOB_FEATURE_PIGLIN_PRISONER = MODDED_FEATURES.register("mob_feature_piglin_prisoner", () -> new MobFeature<PiglinPrisonerEntity>(ModEntityTypes.PIGLIN_PRISONER.get()));
	...
	public static final RegistryObject<Feature<NoneFeatureConfiguration>> MOB_FEATURE_WARPED_ENDERMAN = MODDED_FEATURES.register("mob_feature_warped_enderman", () -> new MobFeature<WarpedEnderManEntity>(ModEntityTypes.WARPED_ENDERMAN.get()));
