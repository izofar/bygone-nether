...
public abstract class ModLists {
	...
	public static final List<Supplier<Structure<?>>> DELTALESS_STRUCTURES = ImmutableList.of(() -> Structure.BASTION_REMNANT, ModStructures.CATACOMB::get, ModStructures.CITADEL::get);
	...
	public static final WeightedRandomList<Supplier<EntityType<? extends AbstractPiglinEntity>>> PIGLIN_PRISONER_CONVERSIONS = WeightedRandomList.create(
			WeightedEntry.of((Supplier<EntityType<? extends AbstractPiglinEntity>>) () -> EntityType.PIGLIN, 4),
			WeightedEntry.of((Supplier<EntityType<? extends AbstractPiglinEntity>>) ModEntityTypes.PIGLIN_HUNTER::get, 3),
			WeightedEntry.of((Supplier<EntityType<? extends AbstractPiglinEntity>>) () -> EntityType.PIGLIN_BRUTE, 1)
	);
}
