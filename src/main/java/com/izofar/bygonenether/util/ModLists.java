...
public abstract class ModLists {
	...
	public static final List<StructureFeature<?>> DELTALESS_STRUCTURES = ImmutableList.of(StructureFeature.BASTION_REMNANT, ModStructures.CATACOMB.get(), ModStructures.NETHER_FORTRESS.get(), ModStructures.CITADEL.get());
